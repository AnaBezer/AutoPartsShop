...
namespace AutoPartsShop.DataAccess.Migrations
{
    ...
    [Migration("20231022183433_Initial_Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoPartsShop.DataAccess.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Brand = "BOSCH",
                            CategoryId = 1,
                            Description = "Rear Axle, Low-Metallic, with anti-squeak plate, with mounting manual.              OENs: A 001 420 01 20, 001 420 01 20.",
            ...
            modelBuilder.Entity("AutoPartsShop.DataAccess.Entities.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoPartsShop.DataAccess.Entities.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoPartsShop.DataAccess.Entities.ShoppingCartProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoPartsShop.DataAccess.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoPartsShop.DataAccess.Entities.Product", b =>
                {
                    b.HasOne("AutoPartsShop.DataAccess.Entities.ProductCategory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AutoPartsShop.DataAccess.Entities.ShoppingCartProduct", b =>
                {
                    b.HasOne("AutoPartsShop.DataAccess.Entities.Product", null)
                        .WithMany()
